...
class OrderModel extends Model
{
     ...
     * @throws \think\exception\DbException
     */
    public function getMcOrderListByWhere($where, $offset, $limit)
    {
        $db = new Db();
        return $db::table('s_mcorder')->where($where)->limit($offset, $limit)->order('id desc')->select();
    }

    public function gettxOrderListByWhere($where, $offset, $limit)
    {
        $db = new Db();
        return $db::table('s_withdrawalorder')->where($where)->limit($offset, $limit)->order('id desc')->select();
    }
     ...
     * @throws \think\Exception
     */
    public function getmcOrderListCount($where)
    {
        $db = new Db();
        return $db::table('s_mcorder')->where($where)->count();
    }

    public function gettxOrderListCount($where)
    {
        $db = new Db();
        return $db::table('s_withdrawalorder')->where($where)->count();
    }
    /**
     * 获取全部下单成功的数量
     * @param $where
